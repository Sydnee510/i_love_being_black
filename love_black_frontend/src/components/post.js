class Post {
    ...
    renderLi(){
        return `<li data-id=${this.id}>${this.content}, ${this.state}, ${this.country}, comments: ${this.renderComments(this.comments)},  <button type="button" id=${this.id} class="delete-post"> DELETE </button>
